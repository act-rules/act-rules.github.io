...
Else If the user in not available, return [step1-cannottell](#step1-cannottell)
...
| type        | TestResult
| outcome     | Cannot tell
| description | The language identification algorithm cannot detect with adequate confidence if the primary language of the page is specified correctly, it is necessary manual identification
