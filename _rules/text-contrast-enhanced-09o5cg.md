...
accessibility_requirements:
  ...
  wcag20:1.4.3: # Contrast (Minimum) (A)
    secondary: This success criterion is **less strict** than this rule. This is because this criterion has a lower minimum contrast. This is why some of the failed examples may satisfy this success criterion.
input_aspects:
  - Accessibility Tree
  - DOM Tree
  - CSS Styling
