...
The rule applies to HTML `img` elements and HTML element with the [semantic role][] of `img`, except for elements that are not [included in the accessibility tree][].
