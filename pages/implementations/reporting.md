...
To submit an implementation report, you must run your test tool or test methodology against the [examples](../testcases/) and produce a report. To have your implementation of ACT-R rules added to the ACT-R community website, you will need to provide a report using [EARL in JSON-LD](../earl-reports/).
