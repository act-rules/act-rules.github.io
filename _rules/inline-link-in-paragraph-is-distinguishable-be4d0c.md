...
For each [link history state][] there exists at least one [visible][] [inclusive descendant][] and one [adequate inspection state][] of the [semantic link][] such that at least one of the following is true:
