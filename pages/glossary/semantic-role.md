...
[Roles](https://www.w3.org/TR/wai-aria-1.1/#dfn-role) can be [implicit](#implicit-role) through the element [implicit semantics](https://www.w3.org/TR/wai-aria/#implicit_semantics) or [explicit](#explicit-role) through the [role attribute](https://www.w3.org/TR/html/dom.html#aria-role-attribute).

The [role attribute](https://www.w3.org/TR/html/dom.html#aria-role-attribute) takes a list of tokens. The semantic role is the first valid role in this list. If none of the tokens are valid, the [implicit role](#implicit-role) will be used instead.
