...
const Footer = ({ siteTitle }) => (
	<footer className="app-footer">
		<div className='tags'>
			...
			<p className='tag'>
				Developed with the support of the EU-funded <a target='_blank' rel="noopener noreferrer" href="https://www.w3.org/WAI/">WAI-Tools </a> Project.
		</p>
		</div>
		...
		<div className='logos'>
			...
			{/* wai logo */}
			<a lang="en" className="logo-wai"
				href="https://www.w3.org/WAI/" target='_blank' rel="noopener noreferrer">
				<span className="wai"><span className="wa">Web&nbsp;Accessibility</span> <span className="i"><span className="initieative">Initiative</span> <span>WAI</span></span></span>
			</a>
			...
			<a href={pkg.repository.url} target='_blank' rel="noopener noreferrer"
				...
				<svg enableBackground="new 0 0 512 512" id="Layer_1" version="1.1" width='25' height='25' viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
					<g>
						<path
