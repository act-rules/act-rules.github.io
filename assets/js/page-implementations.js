...
function buildTable(implementationData) {
  ...
  tableData.forEach((rowData, index) => {
    ...
    tdTestToolName.appendChild(document.createTextNode(rowData.vendorTool));
    tr.appendChild(tdTestToolName);

    var tdTestToolVersion = document.createElement('td');
    tdTestToolVersion.appendChild(document.createTextNode(rowData.vendorToolVersion));
    tr.appendChild(tdTestToolVersion);

    var tdVendorName = document.createElement('td');
    tdVendorName.appendChild(document.createTextNode(rowData.vendorName));
