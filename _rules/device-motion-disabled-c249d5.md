...
For each test target, an [instrument][] is available to disable the registered [device orientation event][device orientation] or [device motion event][device motion].
