...
- This rule assumes that reading the URL, for example from the status bar when the link is focused is not part of the context, and so does not disambiguate links.
