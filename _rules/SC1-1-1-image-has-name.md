...
Each target element has an [accessible name](#accessible-name) that dos not only consist of [Unicode separator characters](https://www.unicode.org/versions/Unicode11.0.0/ch04.pdf#G134153), or is marked as [decorative](#decorative).
