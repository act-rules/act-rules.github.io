...
It is important that we in the {{site.title}} Community Group have a shared understanding of what it means for work to be complete.  The Definition of "Done" can be used to assess when work is complete. ([The Scrum Guide](https://www.scrumguides.org/scrum-guide.html#artifact-transparency-done).
...
Sticking to the Definition of "Done" ensures a high quality in rules published by the {{site.title}} Community Group, and ensures transparency in our work. 
...
- The rule is using {{site.title}} [Glossary terms]({{ site.baseurl }}/pages/glossary) whenever possible. Be particularly aware of the following much-used algorithms:
