---
id: g0m9ub
name: Document has repeated content before main content
rule_type: atomic
description: |
  This rule checks that each page has some repeated content before its main content.
...
The test target contains at least one [block of repeated content][] which is located before its [main block of content][]
...
In this document, there is no [block of repeated content][] before the [main block of content][]. The only [block of repeated content][] is located after the [main block of content][].
