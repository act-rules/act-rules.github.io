...
- Accessibility support for [inheriting semantic][inheriting-semantic-role] links may vary depending on the assistive technology in use.
...
```html
See [<a onclick="location.href='https://act-rules.github.io/'" role="doc-biblioref">ACT rules</a>]
```
...
```html
See [<a onclick="location.href='https://act-rules.github.io/'" role="doc-biblioref"></a>]
```
