...
Each [section of content](#section-of-content) in the test target either starts with or is preceded by an element with a [semantic role](#semantic-role) of `heading` which is [visible](#visible) and [included in the accessibility tree](#included-in-the-accessibility-tree).
