...
- The relation between the rule and its accessibility requirements is as described in the [ACT Rules Format](https://www.w3.org/TR/act-rules-format/) under [Accessibility Requirements](https://www.w3.org/TR/act-rules-format/#structure-accessibility-requirements).
  - Remember to also check that the rule is in line with supporting documentation, e.g. [Understanding WCAG 2.1](https://www.w3.org/WAI/WCAG22/Understanding/) and [Techniques for WCAG 2.1](https://www.w3.org/WAI/WCAG22/Techniques/)
...
- The rule links to any relevant documentation, e.g. [Understanding WCAG 2.1](https://www.w3.org/WAI/WCAG22/Understanding/) and [Techniques for WCAG 2.1](https://www.w3.org/WAI/WCAG22/Techniques/), specifications used, etc.
