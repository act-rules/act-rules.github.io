...
rule_type: atomic
description: |
  This rule checks that inline links have both a different background color and a style on hover and focus that distinguishes them from the surrounding text
